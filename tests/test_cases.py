...
@pytest.mark.asyncio
async def test_tc01_local_auto_register():
...
@pytest.mark.asyncio
async def test_tc02_local_p2p_message():
...
@pytest.mark.asyncio
async def test_tc03_nat_traversal_fallback():
...
@pytest.mark.asyncio
async def test_tc04_offline_message_delivery():
...
@pytest.mark.asyncio
async def test_tc05_semantic_search():
...
@pytest.mark.asyncio
async def test_tc06_empty_contact_endpoint_falls_back_offline():
...
@pytest.mark.asyncio
async def test_tc07_inbox_multiple_senders():
...
@pytest.mark.asyncio
async def test_tc08_deliver_endpoint_preserves_message_type(tmp_path, monkeypatch):
    ...
    with TestClient(d.app) as client:
        ...
        msg = await router.receive(receiver_did, timeout=2.0)
