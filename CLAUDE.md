# AgentNexus - CLAUDE.md (updated 2026-04-23)

## 项目概述

AI时代的软件定义网络 - 去中心化Agent通信基础设施。

> **版本和功能状态请查阅 [docs/project-status.md](docs/project-status.md)**（唯一状态源）。
...
> 详见 [docs/project-status.md](docs/project-status.md)。以下仅列开发时常用的快速参考。
...
| `agent_net/node/mcp_server.py` | MCP stdio，37 个工具 |
