...
当前 v1.0.0 范围已收敛为“团队协作开发者预览”：Orchestration SDK + Secretary Phase B 基础闭环 + Web Dashboard 基础入口 + Setup 向导 + 鉴权矩阵 v3。Orchestration SDK 与 Secretary Phase B 已完成开发候选，v1.0.0 剩余重点是 Dashboard/Setup 入口、操作示例和发布文档收口。
